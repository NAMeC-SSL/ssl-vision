...
CameraIntrinsicParameters::CameraIntrinsicParameters() {
  ...
  connect(focal_length_x, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateCameraMat()));
  connect(focal_length_y, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateCameraMat()));
  connect(principal_point_x, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateCameraMat()));
  connect(principal_point_y, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateCameraMat()));

  connect(dist_coeff_k1, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateDistCoeffs()));
  connect(dist_coeff_k2, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateDistCoeffs()));
  connect(dist_coeff_p1, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateDistCoeffs()));
  connect(dist_coeff_p2, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateDistCoeffs()));
  connect(dist_coeff_k3, SIGNAL(hasChanged(VarType *)), this,
          SLOT(updateDistCoeffs()));
